...
developing your extension. When doing so, please ask them in the `#dev` channel.
...
| Module                                                                                                       | Description |
|--------------------------------------------------------------------------------------------------------------|---|
| [`lib-cookieinterceptor`](https://github.com/yuzono/anime-extensions/tree/main/lib/cookieinterceptor) | Injects cookies into OkHttp requests for a given domain |
| [`lib-cryptoaes`](https://github.com/yuzono/anime-extensions/tree/main/lib/cryptoaes)                    | AES-CBC decryption compatible with CryptoJS; JSFuck deobfuscation |
| [`lib-randomua`](https://github.com/yuzono/anime-extensions/tree/main/lib/randomua)                      | Fetches and rotates real-world User-Agent strings |
| [`lib-synchrony`](https://github.com/yuzono/anime-extensions/tree/main/lib/synchrony)                    | JavaScript deobfuscation via the Synchrony engine (QuickJS sandbox) |
| [`lib-textinterceptor`](https://github.com/yuzono/anime-extensions/tree/main/lib/textinterceptor)        | Renders plain text or HTML as a PNG image page |
| [`lib-unpacker`](https://github.com/yuzono/anime-extensions/tree/main/lib/unpacker)                      | Unpacks Dean Edwards-packed JavaScript; substring extraction helpers |
...
- Release build: `app.anikku` or `app.aniyomi`
- Preview build: `app.anikku.beta` or `app.aniyomi.beta`
