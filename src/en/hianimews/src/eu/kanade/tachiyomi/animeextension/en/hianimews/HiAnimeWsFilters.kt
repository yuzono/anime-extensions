...
object HiAnimeWsFilters {
    ...
    internal class TypesFilter : CheckBoxFilterList("Types", "type", HiAnimeWsFiltersData.TYPES)
    internal class GenresFilter : TriStateFilterList("Genres", "genre", HiAnimeWsFiltersData.GENRES)
    internal class StatusFilter : CheckBoxFilterList("Status", "status", HiAnimeWsFiltersData.STATUS)

    internal class SortByFilter : QueryPartFilter("Sort By", "sort", HiAnimeWsFiltersData.SORT_BY)

    internal class SeasonsFilter : CheckBoxFilterList("Season", "season", HiAnimeWsFiltersData.SEASONS)
    internal class YearsFilter : CheckBoxFilterList("Year", "year", HiAnimeWsFiltersData.YEARS)
    internal class RatingFilter : CheckBoxFilterList("Rating", "rating", HiAnimeWsFiltersData.RATINGS)
    internal class CountriesFilter : CheckBoxFilterList("Origin Country", "country", HiAnimeWsFiltersData.COUNTRIES)
    internal class LanguagesFilter : CheckBoxFilterList("Language", "language", HiAnimeWsFiltersData.LANGUAGES)
    ...
    private object HiAnimeWsFiltersData {
