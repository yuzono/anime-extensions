...
object AniGoFilters {
    ...
    internal class TypesFilter : CheckBoxFilterList("Types", "type", AniGoFiltersData.TYPES)
    internal class GenresFilter : TriStateFilterList("Genres", "genre", AniGoFiltersData.GENRES)
    internal class StatusFilter : CheckBoxFilterList("Status", "status", AniGoFiltersData.STATUS)
    internal class SortByFilter : QueryPartFilter("Sort By", "sort", AniGoFiltersData.SORT_BY)
    internal class SeasonsFilter : CheckBoxFilterList("Season", "season", AniGoFiltersData.SEASONS)
    internal class YearsFilter : CheckBoxFilterList("Year", "year", AniGoFiltersData.YEARS)
    internal class RatingFilter : CheckBoxFilterList("Rating", "rating", AniGoFiltersData.RATINGS)
    internal class CountriesFilter : CheckBoxFilterList("Origin Country", "country", AniGoFiltersData.COUNTRIES)
    internal class LanguagesFilter : CheckBoxFilterList("Language", "language", AniGoFiltersData.LANGUAGES)
    ...
    private object AniGoFiltersData {
        ...
        val YEARS = listOf(
            Pair("2027", "2027"), Pair("2026", "2026"), Pair("2025", "2025"),
            ...
            Pair("2000", "2000"), Pair("1990s", "1990s"), Pair("1980s", "1980s"),
            Pair("1970s", "1970s"), Pair("1960s", "1960s"), Pair("1950s", "1950s"),
            Pair("1940s", "1940s"), Pair("1930s", "1930s"), Pair("1920s", "1920s"),
            Pair("1910s", "1910s"), Pair("1900s", "1900s"),
        )
